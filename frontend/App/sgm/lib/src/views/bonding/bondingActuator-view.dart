...
class BondingActuator extends StatefulWidget {
  late BuildContext context;
  BondingActuator(this.context, {super.key}) {
    //Responsive method
  ...
  @override
  State<BondingActuator> createState() => _BondingActuator();
}

class _BondingActuator extends State<BondingActuator> {
  late bool invisible;
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            Text(
              'Ingresa las credenciales de tu conexión a Wifi para que el actuador pueda conectarse a tu red.',
