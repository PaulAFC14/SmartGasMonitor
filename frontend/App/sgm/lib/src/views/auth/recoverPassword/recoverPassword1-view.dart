...
class RecoverPasswordView1 extends StatefulWidget {
  late BuildContext context;
  RecoverPasswordView1(this.context, {super.key}) {
    //Responsive method
  ...
  @override
  State<RecoverPasswordView1> createState() => _RecoverPasswordView1();
}

class _RecoverPasswordView1 extends State<RecoverPasswordView1> {
  late bool invisible;
