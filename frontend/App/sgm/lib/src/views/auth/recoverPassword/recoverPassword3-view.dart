...
class RecoverPasswordView3 extends StatefulWidget {
  late BuildContext context;
  RecoverPasswordView3(this.context, {super.key}) {
    //Responsive method
  ...
  @override
  State<RecoverPasswordView3> createState() => _RecoverPasswordView3();
}

class _RecoverPasswordView3 extends State<RecoverPasswordView3> {
  late bool invisible;
