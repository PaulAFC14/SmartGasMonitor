...
class SendingCredentials extends StatefulWidget {
  late BuildContext context;
  SendingCredentials(this.context, {super.key}) {
    //Responsive method
  ...
  @override
  State<SendingCredentials> createState() => _SendingCredentials();
}

class _SendingCredentials extends State<SendingCredentials> {
  late bool invisible;
