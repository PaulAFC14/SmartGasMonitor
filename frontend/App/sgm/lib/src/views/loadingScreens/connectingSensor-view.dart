...
class ConnectingSensor extends StatefulWidget {
  late BuildContext context;
  ConnectingSensor(this.context, {super.key}) {
    //Responsive method
  ...
  @override
  State<ConnectingSensor> createState() => _ConnectingSensor();
}

class _ConnectingSensor extends State<ConnectingSensor> {
  late bool invisible;
